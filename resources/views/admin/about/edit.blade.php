                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('about.update',['id'=>$about->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" name="title" class="form-control" id="inputTitle" placeholder="عنوان" value="{{$about->title}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <textarea name="text" class="form-control" id="inputImage" placeholder="متن درباره ما">{{$about->text}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img src="/{{$about->image}}" width="100" height="100" class="mt-3 rounded">
                                </div>
                                <div class="col-sm-1">
