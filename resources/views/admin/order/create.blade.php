        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="{{route('article.store')}}" method="post" enctype="multipart/form-data">
                ...
                <fieldset class="content-group">
                    <legend class="text-bold">افزودن مقاله</legend>

                    <div class="form-group">
                        <label class="control-label col-lg-2">عنوان مقاله</label>
                        <div class="col-lg-10">
                            <input type="text" name="title" class="form-control" autofocus value="{{old('name')}}">
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10">
                            @foreach($categories as $category)
                                <div class="checkbox" style="float: right; margin-right: 20px;">
                                    <label>
                                        <input type="checkbox" class="styled"  name="category[]" value="{{$category->id}}">
                                        {{$category->name}}
                                    </label>
                                </div>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="5" cols="5" name="description" class="form-control" placeholder="متن کوتاه ..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="10" cols="5" name="text" class="form-control" placeholder="متن کامل ..."></textarea>
                        </div>
                    </div>
