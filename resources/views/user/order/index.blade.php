    ...
    <!-- Page header -->
        <div class="page-header-content">
            <div class="page-title">
                <h4><span class="text-semibold">پنل کاربر</span> - سفارشات </h4>
            </div>
        </div>
...
@section('content')
            ...
            <table class="table table-striped media-library table-lg">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="/user/zarinpal" method="post">
                            {{csrf_field()}}
                            <input type="hidden" name="order_id" value="{{$order->id}}">
                            <button class="btn btn-success @if($order->zarinStatus==100) disabled @endif" style="border-radius: 5px !important;">پرداخت</button>
                        </form>
                    </td>
                    <td class="text-center">
                        {{--@if($order->status==0)--}}
                        ...
                        <ul class="icons-list">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="/user/order/{{$order->id}}"><i class="icon-search4"></i>جزئیات</a></li>
                                    {{--<li class="divider"></li>--}}
    ...
    <script type="text/javascript">
        @if(session()->get('transaction')=='failOrCancel')
            swal({
            text: "پرداخت شما ناموفق بود لطفا مجددا تلاش نمایید",
            icon: "warning",
            button: "تایید",
