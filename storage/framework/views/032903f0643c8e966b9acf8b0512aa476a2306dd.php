                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('product.store')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-11">
                                    <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" id="color-<?php echo e($color->id); ?>" name="color[]" value="<?php echo e($color->id); ?>" class="custom-control-input">
                                            <label class="custom-control-label" for="color-<?php echo e($color->id); ?>"><?php echo e($color->title); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" id="size-<?php echo e($size->id); ?>" name="size[]" value="<?php echo e($size->id); ?>" class="custom-control-input">
                                            <label class="custom-control-label" for="size-<?php echo e($size->id); ?>"><?php echo e($size->title); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            ...
                            <a href="<?php echo e(route('product.index')); ?>" class="btn btn-danger" type="submit">بازگشت</a>
                        </form>
                    </div>
                </div>
